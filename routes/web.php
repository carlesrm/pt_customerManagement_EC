...
Route::get('/', [CustomerController::class, 'customers'])->name('customers.index');

Route::prefix('customers')->group(function () {
    Route::get('/{customerId}', [CustomerController::class, 'customer'])->name('customers.customer');
    ...
    Route::get('/update', [CustomerController::class, 'updateCustomer'])->name('customers.update');
    Route::post('/update', [CustomerController::class, 'updateCustomerPost'])->name('customers.update.post');

    Route::get('/delete/{customerId}', [CustomerController::class, 'deleteCustomer'])->name('customers.delete');
});
