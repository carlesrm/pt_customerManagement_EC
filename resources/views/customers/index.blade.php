...
@section('content')
    <div class="w-full">
        ...
        <div class="grid grid-cols-3 gap-3 mt-3">
            @foreach($customers as $customer)
                <div class="flex gap-x-3 p-4 bg-gray-50 border border-gray-200 shadow-md hover:shadow-lg rounded-lg cursor-pointer js-card transition-shadow duration-75" data-id="{{ $customer->id }}">
                    ...
                    <div class="relative -top-2 -right-2 js-options z-10">
    ...
    <script>
        document?.addEventListener('DOMContentLoaded', () => {
            const customerCards = document?.querySelectorAll('.js-card');
